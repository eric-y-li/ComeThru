...
def index():
    ...
    return render_template("index.html", displayevents = displayevents, username = username[0]["username"])
...
def form():
    ...
    if request.method == "POST":
        ...
        result = db.execute("INSERT INTO events (eventname, starttime, endtime, description, eventhost, userid, privacy, timecreated, createdby) VALUES (:eventname, :starttime, :endtime, :description, :eventhost, :userid, :privacy, DATETIME(CURRENT_TIMESTAMP, 'localtime'), :username)",
